                     ...
                     <div className="flex items-center gap-4 mb-6">
                        <div className="size-16 shrink-0">
                            <svg viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full drop-shadow-[0_0_15px_rgba(19,127,236,0.5)]">
                                <defs>
                                    <linearGradient id="login-bg-gradient" x1="0" y1="0" x2="200" y2="200" gradientUnits="userSpaceOnUse">
                ...
                <div className="w-full max-w-md space-y-8">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                            Please enter your credentials to access your engineering workspaces.
                        </p>
                    </div>
